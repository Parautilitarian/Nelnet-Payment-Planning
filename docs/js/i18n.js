...
export const strings = {
  en: {
    ...
    installmentDatesHint: "First defaults to pay-now date; others are monthly. Amounts are principal only — plan interest is added to each payment. The last installment auto-fills with any remaining principal.",
  ...
  "zh-Hans": {
    ...
    installmentDatesHint: "第一期默认为一次性付款日期；其余按月递增。金额为每期本金，计划利息另计。最后一期自动填入剩余本金。",
    installmentDate: "日期",
  ...
  "zh-Hant": {
    ...
    installmentDatesLegend: "各期付款日期",
    installmentDatesHint: "第一期預設為一次性付款日期；其餘按月遞增。金額為每期本金，計劃利息另計。最後一期自動填入剩餘本金。",
    installmentDate: "日期",
  ...
  es: {
    ...
    installmentDatesHint:
      "La primera coincide con la fecha de pago completo; las demás son mensuales. Los montos son solo principal; el interés del plan se suma a cada pago. La última cuota se completa automáticamente con el principal restante.",
    ...
    totalInterestAccrued: "Interés total acumulado:",
